...
const totalMothInput=document.getElementById("total-month"),
...
const countingAvailableMoney=()=>{
    ...
    const totalPerCosts=strToNum(costsFlat)+strToNum(costsHouseServices)+strToNum(costsTransport)+strToNum(costsCredit);
    totalMonth=totalPerMonth-totalPerCosts;
    totalMothInput.value=totalMonth;
}
